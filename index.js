...
app.get('/Piggyback/webhook/taskDeleted', function(request, response, next) {
...
app.get('/Piggyback/sendwebhook', function(request, response) {
	onfleet.createWebHook('http://107.170.198.205/Piggyback/webhook/taskDeleted', 8).then(function(data) {
