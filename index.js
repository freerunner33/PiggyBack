...
app.post('/Piggyback/signup', function(request, response) {
	...
	if (key.localeCompare(signupKey) != 0) {
		response.render('signup', {pageTitle: 'Sign up', errors: [key, keys.signupKey, 'Incorrect sign up key. Please contact Noah for a key to sign up'], username: username, firstname: firstname, lastname: lastname, phone: phone})
		return
	}
