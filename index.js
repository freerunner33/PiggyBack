...
app.get('/Piggyback/webhook/taskArrival', function(request, response, next) {
...
app.get('/Piggyback/sendwebhook', function(request, response) {
	onfleet.createWebHook('http://107.170.198.205/Piggyback/webhook/taskArrival', 2).then(function(data) {
